...
{  
    public:
    imageSub(ros::NodeHandle n, std::string &t1, std::string &t2) : it_(n), rgb_image(it_, t1, 1), depth_image(it_, t2, 1), sync(MySyncPolicy(10),rgb_image, depth_image)
    {
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    imageSub im(n, rgbImageNode, depthImageNode);
    ros::spin();
    return 0;
}